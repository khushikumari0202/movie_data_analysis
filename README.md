...
python main.py
💡 Future Work
Implement a Recommendation System based on genre and director.

Perform Sentiment Analysis on movie descriptions to see if "darker" descriptions lead to higher ratings.
